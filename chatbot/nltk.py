...
import nltk
#chat is a class req for logic building that chatbot
#reflections is a dictionary that contains a set of input text and its corresponding output values
from nltk.chat.util import Chat, reflections

#rules to build chatbot
set_pairs = [
    [
        r"my name is (.*)",
...
#define and instatiatethe chatbot
def chatbot():
